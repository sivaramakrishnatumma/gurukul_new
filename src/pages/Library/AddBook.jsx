...
const AddBook = () => {
  ...
  const [addItemData, setAddItemData] = useState({title:'', itemBarCode: '', itemType: '', grade:'', quantity: '', biblioItemId: ''})
        ...
        <CardContent>
          ...
          <div className="card-body">
            <FormGroup>
              ...
              <Button variant="contained" className="login-btn" onClick={addItem}>
                ADD
              </Button>
            </FormGroup>
          </div>
